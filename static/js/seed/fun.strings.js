...
fun.strings = {
    ...
    rate: "Rate",
    payoutPercentage: "Payment Percentage",
    ...
    ioFunLandingText: "We combine the best techniques from machine learning, distributed systems and deep networks to build powerful general‑purpose monkeys.",
    ...
    planFutureDiscussionTools: "Review calls, comment on tasks, report issues, and plan the future of your project with communication tools",
    ...
    city: "City",
    zipCode: "ZipCode",
    propertyAddressDifferent: "Property Address Different",
    county: "County",
