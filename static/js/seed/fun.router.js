    ...
    */
    ...
    profile: function(){
        ...
        if (account === 'drknockboot560@gmail.com'){
            ...
            $('#current-4591').removeClass('hide').addClass('show');
        ...
        if (account === 'oilmanreed@hotmail.com'){
            ...
            $('#current-4342').removeClass('hide').addClass('show');
        ...
        if (account === 'toddp@cpbgc.com'){
            ...
            $('#current-7606').removeClass('hide').addClass('show');
        ...
        if (account === 'paul35coachmen@gmail.com'){
            ...
            $('#current-3938').removeClass('hide').addClass('show');
        }
        ...
        if (account === 'lwellszero53@gmail.com'){
            ...
            $('#current-401').removeClass('hide').addClass('show');
        ...
        if (account === 'thompson.charles24@yahoo.com'){
            ...
            $('#current-344a').removeClass('hide').addClass('show');
