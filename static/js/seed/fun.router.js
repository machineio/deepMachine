    ...
    */
    ...
    profile: function(){
        ...
        if (account === 'drknockboot560@gmail.com'){
            ...
            $('#current-4710').removeClass('hide').addClass('show');
        ...
        if (account === 'oilmanreed@hotmail.com'){
            ...
            $('#current-4671').removeClass('hide').addClass('show');
        ...
        if (account === 'toddp@cpbgc.com'){
            ...
            $('#current-10843').removeClass('hide').addClass('show');
        ...
        if (account === 'paul35coachmen@gmail.com'){
            ...
            $('#current-1868').removeClass('hide').addClass('show');
            ...
            $('#current-4027').removeClass('hide').addClass('show');
        }
            ...
            $('#current-1239').removeClass('hide').addClass('show');
        }
        ...
        if (account === 'lwellszero53@gmail.com'){
            ...
            $('#current-542').removeClass('hide').addClass('show');
        ...
        if (account === 'sandwalker99@hotmail.com'){
            ...
            $('#current-673').removeClass('hide').addClass('show');
        ...
        if (account === 'thompson.charles24@yahoo.com'){
            ...
            $('#current-485').removeClass('hide').addClass('show');
        ...
        if (account === 'deannajohnh@gmail.com'){
            ...
            $('#current-1410').removeClass('hide').addClass('show');
        ...
        if (account === 'sarjmussa@gmail.com'){
            fun.utils.hideAmounts();
            fun.utils.hideAccountsHistory();
