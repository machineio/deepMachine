    ...
    */
    ...
    profile: function(){
        ...
        if (account === 'drknockboot560@gmail.com'){
            ...
            $('#current-4699').removeClass('hide').addClass('show');
        ...
        if (account === 'imcy123@aol.com'){
            ...
            $('#current-1210').removeClass('hide').addClass('show');
        ...
        if (account === 'oilmanreed@hotmail.com'){
            ...
            $('#current-4479').removeClass('hide').addClass('show');
        ...
        if (account === 'toddp@cpbgc.com'){
            ...
            $('#current-8588').removeClass('hide').addClass('show');
        ...
        if (account === 'paul35coachmen@gmail.com'){
            ...
            $('#current-1618').removeClass('hide').addClass('show');
            ...
            $('#current-4059').removeClass('hide').addClass('show');
        }
            ...
            $('#current-1299').removeClass('hide').addClass('show');
        }
            ...
            $('#current-503').removeClass('hide').addClass('show');
        ...
        if (account === 'lwellszero53@gmail.com'){
            ...
            $('#current-532').removeClass('hide').addClass('show');
        ...
        if (account === 'sandwalker99@hotmail.com'){
            ...
            $('#current-632').removeClass('hide').addClass('show');
        ...
        if (account === 'thompson.charles24@yahoo.com'){
            ...
            $('#current-475').removeClass('hide').addClass('show');
        ...
        if (account === 'deannajohnh@gmail.com'){
            ...
            $('#current-649').removeClass('hide').addClass('show');
        ...
        if (account === 'johnsontildeath80@gmail.com'){
            ...
            $('#current-351b').removeClass('hide').addClass('show');
        ...
        if (account === 'mikec0141@gmail.com'){
            ...
            $('#current-342b').removeClass('hide').addClass('show');
