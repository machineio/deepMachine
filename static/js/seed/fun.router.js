    ...
    */
    ...
    profile: function(){
        ...
        if (account === 'drknockboot560@gmail.com'){
            ...
            $('#current-4537').removeClass('hide').addClass('show');
        ...
        if (account === 'oilmanreed@hotmail.com'){
            ...
            $('#current-2284').removeClass('hide').addClass('show');
        ...
        if (account === 'toddp@cpbgc.com'){
            ...
            $('#current-7479').removeClass('hide').addClass('show');
        ...
        if (account === 'paul35coachmen@gmail.com'){
            ...
            $('#current-1514').removeClass('hide').addClass('show');
            ...
            $('#current-480').removeClass('hide').addClass('show');
        ...
        if (account === 'thompson.charles24@yahoo.com'){
            ...
            $('#current-351').removeClass('hide').addClass('show');
