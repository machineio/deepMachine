    ...
    */
    ...
    profile: function(){
        ...
        if (account === 'paul35coachmen@gmail.com'){
            ...
            $('#current-1503').removeClass('hide').addClass('show');
            ...
            $('#current-1233').removeClass('hide').addClass('show');
        }
        ...
        if (account === 'lwellszero53@gmail.com'){
            ...
            $('#current-360').removeClass('hide').addClass('show');
        ...
        if (account === 'thompson.charles24@yahoo.com'){
            ...
            $('#current-315').removeClass('hide').addClass('show');
